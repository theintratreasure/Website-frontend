...
const PAGE_SEO = {
  title: "Trading Platform | FP Trades",
  description:
    "Explore the FP Trades trading platform with multi-device access, execution tools, charting capabilities and risk controls.",
