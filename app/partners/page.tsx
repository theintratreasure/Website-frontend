...
const PAGE_SEO = {
  title: "Partners | Affiliate and IB Programs at FP Trades",
  description:
    "Explore FP Trades partner models including affiliate and introducing broker opportunities with transparent reward structures.",
  path: "/partners",
  pageKeywords: [
    "FP Trades partners",
